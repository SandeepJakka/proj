...
const TRANSLATIONS = {
  english: {
    ...
    nav_profile: 'Profile',
    nav_logout: 'Logout',
    ai_online: 'Vaidya Assist AI Online',
    dash_greeting: 'Good day',
    dash_subtitle: 'Your Vaidya Assist AI is ready to assist you.',
    ...
    rem_scan_hint_desc: 'Upload your doctor\'s prescription photo and Vaidya Assist AI will automatically detect all medicines and help you set reminders for each one.',
  ...
  telugu: {
    ...
    ai_online: 'Vaidya Assist AI ఆన్లైన్',
    dash_greeting: 'శుభోదయం',
    dash_subtitle: 'మీ Vaidya Assist AI సహాయానికి సిద్ధంగా ఉంది.',
    ...
    rem_scan_hint_desc: 'మీ వైద్యుని ప్రిస్క్రిప్షన్ ఫోటో అప్లోడ్ చేయండి, Vaidya Assist AI అన్ని మందులను గుర్తించి రిమైండర్లు సెట్ చేయడంలో సహాయపడుతుంది.',
